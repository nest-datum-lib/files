...
export class SystemStatusController {
	...
	@MessagePattern({ cmd: 'systemStatus.drop' })
	async drop(payload) {
		try {
	...
	@MessagePattern({ cmd: 'systemStatus.dropMany' })
	...
	@MessagePattern({ cmd: 'systemStatus.create' })
	...
	@MessagePattern({ cmd: 'systemStatus.update' })
