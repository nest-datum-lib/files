...
export class SystemOptionController {
	...
	@MessagePattern({ cmd: 'systemOption.drop' })
	async drop(payload) {
		try {
	...
	@MessagePattern({ cmd: 'systemOption.dropMany' })
	...
	@MessagePattern({ cmd: 'systemOption.create' })
	...
	@MessagePattern({ cmd: 'systemOption.update' })
