	...
	async send() {
		...
		try {
			...
			await Bluebird.each([{
				...
				id: 'files-setting-transport-provider',
				...
				id: 'files-setting-transport-host',
				name: 'Service host',
				...
				id: 'files-setting-transport-port',
				name: 'Service port',
				...
				id: 'files-setting-cache-namespace',
